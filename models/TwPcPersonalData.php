...
class TwPcPersonalData extends Model{	
	...
	//NOTAS
		//SI EL BLOQUE RETORNA "INACTIVO" ES POR QUE EL ROL DEL EMPLEADO NO PUEDE VISUALIZAR ESA INFORMACION
...
$rows->bindParam(":BLOQUE9", $BLOQUE9, PDO::PARAM_STR,1000); //ULTIMAS NOTICIAS
$rows->bindParam(":BLOQUE10", $BLOQUE10, PDO::PARAM_STR,2000); //COMPROBANTES DE PAGO
$rows->bindParam(":BLOQUE11", $BLOQUE11, PDO::PARAM_STR,2000); //DIAS VACACIONES
$rows->bindParam(":BLOQUE12", $BLOQUE12, PDO::PARAM_STR,2000); //REGISTRA TUS NOVEDADES
$rows->bindParam(":BLOQUE13", $BLOQUE13, PDO::PARAM_STR,2000); //CERTIFICADO LABORAL
$rows->bindParam(":BLOQUE14", $BLOQUE14, PDO::PARAM_STR,2000); //CERTIFICADOS DE INGRESOS Y RETENCION
